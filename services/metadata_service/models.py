...
class DimensionMember(Base):
    ...
    parent_relationships = relationship(
        "MemberRelationship",
        foreign_keys="MemberRelationship.parent_member_id",
        back_populates="parent_member",
        cascade="all, delete-orphan",
    )
    child_relationships = relationship(
        "MemberRelationship",
        foreign_keys="MemberRelationship.child_member_id",
        back_populates="child_member",
        cascade="all, delete-orphan",
    )
...
class MemberRelationship(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("parent_member_id <> child_member_id", name="ck_member_relationship_no_self"),
    )
    ...
    parent_member = relationship(
        "DimensionMember",
        foreign_keys=[parent_member_id],
        back_populates="parent_relationships",
    )
    child_member = relationship(
        "DimensionMember",
        foreign_keys=[child_member_id],
